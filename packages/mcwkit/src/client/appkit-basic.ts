import { type ChainNamespace } from '@mcw/mcwkit-common'
import type { ChainAdapter } from '@mcw/mcwkit-core'
import {
  AccountController,
...
export class AppKit extends AppKitCore {
  ...
  protected override async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import('@mcw/mcwkit-scaffold-ui/basic')
      await import('@mcw/mcwkit-scaffold-ui/w3m-modal')
